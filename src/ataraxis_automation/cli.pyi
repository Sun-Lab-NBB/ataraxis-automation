...
def install_project(environment_name: str, environment_directory: Path | None) -> None: ...
def uninstall_project(environment_name: str, environment_directory: Path | None) -> None: ...
def create_environment(environment_name: str, python_version: str, environment_directory: Path | None) -> None: ...
def remove_environment(environment_name: str, environment_directory: Path | None) -> None: ...
def provision_environment(environment_name: str, python_version: str, environment_directory: Path | None) -> None: ...
